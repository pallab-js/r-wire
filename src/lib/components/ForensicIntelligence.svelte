...
>
  <div class="grid grid-cols-1 md:grid-cols-2 gap-6 max-w-4xl">
    <!-- Risk Score Gauge -->
    <div
      class="p-6 rounded border flex flex-col items-center justify-center text-center"
    ...
    >
      ...
      <p
        ...
        style="font-family: var(--font-serif); font-feature-settings: 'cswh';"
      >
    ...
    >
      ...
      <div class="flex items-end gap-3 mb-3">
        ...
        >
          {intelligence.entropy.toFixed(4)}
        </div>
        <span class="text-xs pb-1 opacity-50" style="font-family: var(--font-mono);"
          >bits per byte</span
        >
      </div>
      <div
      ...
      >
        <div
          ...
          style="width: {(intelligence.entropy / 8) * 100}%; background-color: var(--color-read);"
        ></div>
      </div>
      <p
        class="text-sm italic"
        style="color: var(--color-success); font-family: var(--font-serif); font-feature-settings: 'cswh';"
      >
        {getEntropyDescription(intelligence.entropy)}
      </p>
    </div>

    <!-- Fingerprints & Metadata -->
    <div
      class="p-6 rounded border md:col-span-2"
      style="background-color: var(--surface-200); border-color: var(--border-primary);"
    >
      <h3
        class="text-xs font-bold uppercase tracking-widest mb-4"
      ...
      <div class="flex flex-col gap-4">
        <div class="flex flex-col gap-1">
          <span
            ...
            style="color: var(--color-read); font-family: var(--font-mono);"
            >TLS JA3 Fingerprint</span
          >
          <code
            class="p-3 rounded font-mono text-sm break-all"
            style="background-color: var(--surface-100); border: 1px solid var(--border-primary); font-family: var(--font-mono);"
          >
        ...
        <div class="flex flex-col gap-1">
          <span
            class="text-xs font-bold uppercase"
            style="color: var(--color-read); font-family: var(--font-mono);"
            >Device Manufacturer (OUI)</span
          >
          <div
            class="p-3 rounded text-sm"
            style="background-color: var(--surface-100); border: 1px solid var(--border-primary); font-family: var(--font-gothic);"
          >
